...
public class YYTextContainerView: UIView {
    ...
    @objc public var textVerticalAlignment: YYTextVerticalAlignment = .top {
        didSet {
    ...
    @objc public var layout: YYTextLayout? {
        willSet {
    ...
    public func set(layout: YYTextLayout?, with fadeDuration: TimeInterval) {
    ...
    public override func draw(_ rect: CGRect) {
        ...
        if attachmentChanged {
            ...
            for a: YYTextAttachment in layout?.attachments ?? [] {
