...
fileprivate func YYTextAsyncLayerGetDisplayQueue() -> DispatchQueue {
 ...
 */
@objc public protocol YYTextAsyncLayerDelegate: NSObjectProtocol {
 ...
 */
public class YYTextAsyncLayer: CALayer {
    ...
    private func _displayAsync(_ async: Bool) -> Void {
        ...
        weak var tmpdelegate = self.delegate as? YYTextAsyncLayerDelegate
        let task: YYTextAsyncLayerDisplayTask? = tmpdelegate?.newAsyncDisplayTask()
        if task?.display == nil {
        ...
        if async {
            ...
            YYTextAsyncLayerGetDisplayQueue().async(execute: {
                if isCancelled() {
                    return
                }
 ...
 */
public class YYTextAsyncLayerDisplayTask: NSObject {
