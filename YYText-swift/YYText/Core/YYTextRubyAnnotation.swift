 ...
 */
public class YYTextRubyAnnotation: NSObject, NSCopying, NSCoding, NSSecureCoding {
    ...
    public class func ruby(with ctRuby: CTRubyAnnotation) -> YYTextRubyAnnotation {
        
        let one = YYTextRubyAnnotation()
