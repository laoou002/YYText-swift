...
public class YYTextUtilities: NSObject {
    ...
    @objc public static var sharedApplication: UIApplication? {
        ...
        return YYTextUtilities.isAppExtension ? nil : UIApplication.shared
    }
    ...
    @objc @inline(__always) public static func textIsLinebreakString(_ str: String?) -> Bool {
        ...
        if s.length == 1 {
            ...
            return YYTextUtilities.textIsLinebreakChar((c))
        } else {
    ...
    @objc @inline(__always) public static func textLinebreakTailLength(_ str: String?) -> Int {
        ...
        if s.length == 1 {
            return YYTextUtilities.textIsLinebreakChar(s.character(at: 0)) ? 1 : 0
        } else {
            let c2 = s.character(at: s.length - 1)
            if YYTextUtilities.textIsLinebreakChar((c2)) {
