...
public extension UIView {
    ...
    @objc var yy_viewController: UIViewController? {
        get {
    ...
    @objc var yy_visibleAlpha: CGFloat {
        get {
            if (self is UIWindow) {
                if isHidden {
                    return 0
    ...
    @objc func yy_convertPoint(_ point: CGPoint, toViewOrWindow view: UIView?) -> CGPoint {
        var point = point
        if view == nil {
            if (self is UIWindow) {
    ...
    @objc func yy_convertPoint(_ point: CGPoint, fromViewOrWindow view: UIView?) -> CGPoint {
        var point = point
        if view == nil {
            if (self is UIWindow) {
    ...
    @objc func yy_convertRect(_ rect: CGRect, toViewOrWindow view: UIView?) -> CGRect {
        var rect = rect
        if view == nil {
            if (self is UIWindow) {
    ...
    @objc func yy_convertRect(_ rect: CGRect, fromViewOrWindow view: UIView?) -> CGRect {
        var rect = rect
        if view == nil {
            if (self is UIWindow) {
